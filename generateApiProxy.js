...
// 計算當前檔案的目錄路徑，Deno 中的 __dirname 等效實現
 ...
 */
export function generateApiProxyFile(app) { // 移除 TypeScript 類型註解
    ...
    app._router.stack.forEach((layer) => { // 移除 TypeScript 類型註解
        if (layer.route) {
